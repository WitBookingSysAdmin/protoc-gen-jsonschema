...
RUN wget https://github.com/WitBookingSysAdmin/protoc-gen-jsonschema/releases/download/v0.9.5/protoc-gen-jsonschema-linux-amd64 -O /bin/protoc-gen-jsonschema && chmod +x /bin/protoc-gen-jsonschema
